...
//   const navigation = useNavigation();
//   const route = useRoute();
//   const { token, items, category } = route.params;
//   const order = items[0];
...
//         index: 0,
//         routes: [
//           { name: ROUTES.OrderTrackingTab, params: { email: order.userEmail, orderId: order.orderId, order, token } },
//         ],
//       })
//     );
//   };
...
//     navigation.navigate(ROUTES.MainTab); // Navigate to the MainTab when back is pressed
//   };

//   return (
//     <ScrollView contentContainerStyle={styles.container}>
//       <SettingsHeader title={'Payment'} onPress={handleBackPress} />
//       <View style={{ flexDirection: 'column', justifyContent: 'space-between' }}>
//         <View style={{ marginTop: 40, marginBottom: 20 }}>
//           <View style={styles.paymentDetailsSection}>
//             <Text style={styles.subHeader}>ASHOK TEXTILES BANK ACCOUNT DETAILS</Text>
...
const Payment = () => {
  ...
  const handleBackPress = () => {
    navigation.navigate(ROUTES.MainTab); // Navigate to the MainTab when back is pressed
    return true; // Returning true indicates that the back button event has been handled
  };

  // useEffect to handle hardware back button
  useEffect(() => {

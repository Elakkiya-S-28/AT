    ...
    try {
      ...
      if (response.data.message.length > 0) {
        ...
        if (firstProduct.category === 'yarn') {
          navigation.navigate(ROUTES.Yarn, { token, email, product: response.data.message });
    ...
    >
      <View style={styles.modalOverlay}>
        <View style={styles.modalContainer}>
          ...
          <Text style={styles.modalMessage}>Would you like to purchase {selectedCategory}?</Text>
  ...
  return (
    <View style={styles.container}>
      <View style={styles.headerContainer}>
        ...
        <Image source={ICONS.logout} style={{ height: 24, width: 24, tintColor: 'white', alignItems: 'center', marginTop: 3 }} />
      </View>
      <View style={styles.bodyContainer}>
        ...
        <FlatList
          data={categories}
          renderItem={({ item }) => (
            <TouchableOpacity style={styles.card} onPress={() => handleCategoryPress(item.category)}>
